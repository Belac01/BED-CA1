...
module.exports.insertIntoUserInventory = (inventoryData, callback) => {
    const SQL_STATEMENT = `
        INSERT INTO UserInventory (user_id, item_name, description, acquisition_date)
        VALUES (?, ?, ?, NOW());
    `;
    const VALUES = [inventoryData.userId, inventoryData.itemName, inventoryData.description];
